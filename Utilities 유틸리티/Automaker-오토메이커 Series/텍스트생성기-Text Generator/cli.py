...
def main():
    parser = argparse.ArgumentParser(description="Text Generator CLI - Dummy Text Tool")
    parser.add_argument("--count", type=int, default=1, help="Number of paragraphs to generate")
    parser.add_argument("--mode", choices=['korean', 'latin'], default='korean', help="Language mode")
